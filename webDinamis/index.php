...
$path_prefix = './';
$page_title  = 'TechNime Blog UAS - 2388010017';
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <h1 class="display-4 fw-bold text-white mb-3 lh-sm" style="letter-spacing: -1.5px;">
                    Portal <span style="background: var(--gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Informatika</span> &amp; <span class="text-secondary">Anime</span> Terkini
                </h1>
                <p class="lead text-muted mb-2" style="font-size: 1.1rem; line-height: 1.8;">
                    <strong class="text-white">TechNime Blog</strong> — wadah berbagi informasi teknologi kecerdasan buatan (AI), berita anime terhangat, dan portofolio IT mahasiswa.
                </p>
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="#informatika" class="btn btn-gradient px-4"><i class="fa-solid fa-brain me-2"></i>Berita AI</a>
                    <a href="#anime"       class="btn btn-outline-custom px-4"><i class="fa-solid fa-film me-2"></i>Dunia Anime</a>
                    <a href="#portofolio"  class="btn btn-outline-custom px-4"><i class="fa-solid fa-briefcase me-2"></i>Portofolio</a>
                    <a href="#peringkat"   class="btn btn-outline-custom px-4"><i class="fa-solid fa-trophy me-2"></i>Peringkat</a>
                </div>
            </div>
            <div class="col-lg-5 text-center d-none d-lg-flex justify-content-center">
                <div class="card bg-dark shadow-lg p-4" style="border-radius: 24px; border: 1px solid var(--border); width: 380px;">
                    <div class="overflow-hidden mb-3" style="border-radius: 16px; height: 200px; background: var(--gradient); display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="text-start">
                        <p class="text-white fw-bold small mb-1"><i class="fa-solid fa-circle-nodes text-primary me-2"></i>AI &amp; Pop Culture Hub</p>
                        <p class="text-muted small mb-0">Konten edukatif IT dikombinasikan dengan review pop kultur jepang.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="alert p-3" style="border-radius:12px;background:rgba(245,158,11,.08);border:1px solid rgba(245,158,11,.15);">
        <div class="d-flex align-items-center text-warning small">
            <i class="fa-solid fa-triangle-exclamation fa-lg me-2"></i>
            <div><strong>Mode Demo Aktif:</strong> Database MySQL belum terhubung. Menampilkan data session sementara.</div>
        </div>
    </div>
</div>
<?php endif; ?>
...
<section id="informatika" class="py-5" style="border-top: 1px solid var(--border);">
    <div class="container py-3">
        <div class="d-flex align-items-center mb-5">
            <div class="rounded-3 me-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:rgba(108,99,255,.12);border:1px solid rgba(108,99,255,.3);color:var(--primary);">
                <i class="fa-solid fa-microchip fa-xl"></i>
            </div>
            <div>
                <h2 class="text-white m-0">Berita Teknologi AI</h2>
                <p class="text-muted small m-0">Update terbaru seputar kecerdasan buatan, machine learning, dan programming.</p>
            </div>
        </div>

        <?php if (empty($it_articles)): ?>
            <div class="text-center py-5 text-muted"><i class="fa-regular fa-folder-open fa-3x mb-3"></i><p class="m-0">Belum ada artikel Informatika.</p></div>
        <?php else: ?>
...
<section id="anime" class="py-5" style="border-top: 1px solid var(--border); background: rgba(255,101,132,.01);">
    <div class="container py-3">
        <div class="d-flex align-items-center mb-5">
            <div class="rounded-3 me-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:rgba(255,101,132,.12);border:1px solid rgba(255,101,132,.3);color:var(--secondary);">
        ...
        <?php if (empty($anime_articles)): ?>
            <div class="text-center py-5 text-muted"><i class="fa-regular fa-folder-open fa-3x mb-3"></i><p class="m-0">Belum ada artikel Anime.</p></div>
        <?php else: ?>
            <div class="row row-cols-1 row-cols-md-2 g-4">
...
<section id="portofolio" class="py-5" style="border-top: 1px solid var(--border);">
    <div class="container py-3">
        <!-- Header Section -->
        <div class="d-flex align-items-center mb-5">
            <div class="rounded-3 me-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:rgba(67,233,123,.12);border:1px solid rgba(67,233,123,.3);color:#43E97B;">
        ...
        <div class="card card-custom p-4 mb-5">
            <div class="row align-items-center g-4">
                <div class="col-md-2 text-center">
                    ...
                    $useDefault = !file_exists($fotoPath) || ($admin_info['foto_profil'] ?? '') === 'default-avatar.png';
                    ?>
                    <?php if (!$useDefault): ?>
                        <img src="<?php echo htmlspecialchars($fotoPath); ?>" class="rounded-circle border border-primary" style="width:90px;height:90px;object-fit:cover;" alt="Foto Profil">
                    <?php else: ?>
                        <div class="rounded-circle border border-primary d-flex align-items-center justify-content-center mx-auto" style="width:90px;height:90px;background:rgba(108,99,255,.1);color:var(--primary);">
                            <i class="fa-solid fa-user-graduate fa-2x"></i>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-md-10">
                    <h4 class="text-white mb-1 brand-font"><?php echo htmlspecialchars($admin_info['nama_lengkap'] ?? 'Muhammad Arif Rizky'); ?></h4>
                    <p class="text-muted mb-1 small">
                        <span class="badge-it me-2"><i class="fa-solid fa-id-badge me-1"></i>NIM: <?php echo htmlspecialchars($admin_info['nim'] ?? '2388010017'); ?></span>
                        <span class="badge-anime"><i class="fa-solid fa-graduation-cap me-1"></i>Teknik Informatika</span>
                    </p>
                    <p class="text-muted mt-2 mb-0" style="line-height:1.7;"><?php echo htmlspecialchars($admin_info['bio_it'] ?? 'Informatics Student & Full-Stack Web Developer.'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
            ...
            <div class="col">
                <div class="card card-custom">
                    ...
                    $noImg = !file_exists($pImg) || ($proj['gambar_proyek'] ?? '') === 'default-project.png';
                    ?>
                    <?php if (!$noImg): ?>
                        <img src="<?php echo htmlspecialchars($pImg); ?>" class="card-img-top" style="height:160px;object-fit:cover;" alt="<?php echo htmlspecialchars($proj['judul_proyek']); ?>">
                    <?php else: ?>
                        <div class="d-flex align-items-center justify-content-center" style="height:160px;background:rgba(108,99,255,.05);">
                            <i class="fa-solid fa-image text-muted fa-3x"></i>
                        </div>
                    <?php endif; ?>
                    <div class="card-body p-4">
                        <h5 class="text-white mb-2"><?php echo htmlspecialchars($proj['judul_proyek']); ?></h5>
                        <p class="text-muted small mb-3" style="line-height:1.6;"><?php echo htmlspecialchars(get_synopsis($proj['deskripsi'], 100)); ?></p>
                        <div class="d-flex flex-wrap gap-1">
                            <?php foreach (explode(',', $proj['tech_stack']) as $tech): ?>
                                <span style="font-size:.68rem;background:rgba(108,99,255,.1);color:var(--primary);border:1px solid rgba(108,99,255,.25);border-radius:20px;padding:.25rem .6rem;" class="fw-semibold"><?php echo htmlspecialchars(trim($tech)); ?></span>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
        ...
        <?php else: ?>
            <div class="text-center text-muted py-4 mb-5"><i class="fa-solid fa-folder-open fa-2x mb-2 d-block"></i>Belum ada proyek IT.</div>
        <?php endif; ?>
...
<section id="peringkat" class="py-5" style="border-top: 1px solid var(--border); background: rgba(255,255,255,.01);">
    <div class="container py-3">
        <div class="d-flex align-items-center mb-5">
            <div class="rounded-3 me-3 d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:rgba(255,193,7,.12);border:1px solid rgba(255,193,7,.3);color:#ffc107;">
                ...
                <table class="table table-custom w-100 m-0">
                    ...
                    <tbody>
                        ...
                        foreach ((array)$rankings as $rank):
                            ...
                            if ($posCounter === 1)     { $badgeClass = 'bg-warning text-dark'; $icon = '<i class="fa-solid fa-crown me-1 text-dark"></i>'; }
                            elseif ($posCounter === 2) { $badgeClass = 'bg-light text-dark';   $icon = '<i class="fa-solid fa-medal me-1 text-secondary"></i>'; }
                            elseif ($posCounter === 3) { $badgeClass = 'bg-danger text-white'; $icon = '<i class="fa-solid fa-award me-1"></i>'; }
                            else                       { $badgeClass = 'bg-dark border border-secondary text-white'; $icon = ''; }
                        ?>
                        <tr>
                            <td class="text-center">
                                <span class="badge <?php echo $badgeClass; ?> px-2 py-2 rounded-3" style="font-size:.9rem;font-weight:700;"><?php echo $icon . $posCounter; ?></span>
                            </td>
                            <td>
                                <strong class="text-white d-block"><?php echo htmlspecialchars($rank['judul_anime']); ?></strong>
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="text-white fw-bold"><?php echo number_format((float)$rank['skor_rating'], 2); ?></span>
                                    <div class="progress flex-grow-1 bg-dark" style="height:6px;border-radius:3px;">
                                        <div class="progress-bar" role="progressbar"
                                             ...
                                             aria-valuenow="<?php echo $rank['skor_rating']; ?>" aria-valuemin="0" aria-valuemax="10">
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td><span class="text-muted small"><?php echo htmlspecialchars($rank['genre']); ?></span></td>
                            <td class="d-none d-md-table-cell"><span class="text-muted small"><?php echo htmlspecialchars(get_synopsis($rank['sinopsis'], 80)); ?></span></td>
                        </tr>
        ...
        <?php else: ?>
            <div class="text-center py-5 text-muted"><i class="fa-solid fa-inbox fa-3x mb-3 d-block"></i>Belum ada data peringkat anime.</div>
        <?php endif; ?>
    </div>
</section>
